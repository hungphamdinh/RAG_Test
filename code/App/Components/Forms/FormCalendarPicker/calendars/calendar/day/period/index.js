...
class Day extends Component {
  ...
  getDrawingStyle(marking) {
    const defaultStyleData = { textStyle: {} };
    if (!marking) {
      return defaultStyle;
    }
    if (marking.disabled) {
      defaultStyleData.textStyle.color = this.theme.textDisabledColor;
    } else if (marking.selected) {
      defaultStyleData.textStyle.color = this.theme.selectedDayTextColor;
    }
