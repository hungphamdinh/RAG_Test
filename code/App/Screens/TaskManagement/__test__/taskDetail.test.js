...
jest.mock('@Components/Forms', () => {
  ...
  return {
    ...
    FormLazyDropdown: ({ name, label, testID, multiple, options, getList, titleKey }) => (
      <FormLazyDropdownMock
        getList={getList}
        options={options}
        name={name}
    ...
    FormDropdown: ({ name, label, testID, options, multiple }) => (
      <FormDropdownMock options={options} name={name} label={label} testID={testID} multiple={multiple} />
    ),
